Contributing to Tessa Core
============================

The Tessa Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tessa Core project, and is not to be
confused with overall Tessa Network Protocol consensus changes.

Whether a pull request is merged into Tessa Core rests with the project merge
...
Patches that change Tessa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tessa consensus, it must have been
...
The project leader is the release manager for each Tessa Core release.
