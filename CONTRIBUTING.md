Contributing to Club Core
============================

The Club Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Club Core project, and is not to be
confused with overall Club Network Protocol consensus changes.

Whether a pull request is merged into Club Core rests with the project merge
...
Patches that change Club consensus rules are considerably more involved than
...
Where a patch set proposes to change the Club consensus, it must have been
...
The project leader is the release manager for each Club Core release.
