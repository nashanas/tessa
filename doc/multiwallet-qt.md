...
In order to support loading of multiple wallets in club-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is club.cpp.
...
Changes to club.cpp
----------------------
club.cpp is the entry point into club-qt, and as such, will require some minor modifications to provide hooks for
