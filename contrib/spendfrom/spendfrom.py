#!/usr/bin/env python
#
# Use the raw transactions API to spend CLUBs received on particular addresses,
...
def determine_db_dir():
    ...
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/CLUB/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "CLUB")
...
def main():
    ...
    parser.add_option("--from", dest="fromaddresses", default=None,
                      help="addresses to get CLUBs from")
    parser.add_option("--to", dest="to", default=None,
                      help="address to get send CLUBs to")
