...
bool StartHTTPRPC() {
  LogPrint(TessaLog::RPC, "Starting HTTP RPC server\n");
...
void InterruptHTTPRPC() { LogPrint(TessaLog::RPC, "Interrupting HTTP RPC server\n"); }

void StopHTTPRPC() {
  LogPrint(TessaLog::RPC, "Stopping HTTP RPC server\n");
