...
void SignVerifyMessageDialog::on_addressBookButton_SM_clicked() {
  if (model && model->getAddressTableModel()) {
    ...
    if (dlg.exec()) { setAddress_SM(dlg.getReturnValue()); }
  }
}
...
void SignVerifyMessageDialog::on_signMessageButton_SM_clicked() {
  ...
  if (!addr.IsValid()) {
    ...
    ui->statusLabel_SM->setText(tr("The entered address is invalid.") + QString(" ") +
...
void SignVerifyMessageDialog::on_addressBookButton_VM_clicked() {
  if (model && model->getAddressTableModel()) {
    ...
    dlg.setModel(model->getAddressTableModel());
    if (dlg.exec()) { setAddress_VM(dlg.getReturnValue()); }
  }
}
...
void SignVerifyMessageDialog::on_verifyMessageButton_VM_clicked() {
  ...
  if (!addr.IsValid()) {
    ...
    ui->statusLabel_VM->setText(tr("The entered address is invalid.") + QString(" ") +
                                tr("Please check the address and try again."));
    return;
  }
  ecdsa::CKeyID keyID;
