...
/* Tessa GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Tessa"
#define QAPP_ORG_DOMAIN "club.org"
#define QAPP_APP_NAME_DEFAULT "Tessa-Qt"
#define QAPP_APP_NAME_TESTNET "Tessa-Qt-testnet"
