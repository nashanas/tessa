...
void TransactionView::setModel(WalletModel* model) {
  ...
  if (model) {
    ...
    columnResizingFixer = new GUIUtil::TableViewLastColumnResizingFixer(transactionView, AMOUNT_MINIMUM_COLUMN_WIDTH,
...
void TransactionView::exportClicked() {
  ...
  if (model) {
    ...
    if (model->haveWatchOnly()) writer.addColumn(tr("Watch-only"), TransactionTableModel::Watchonly);
