...
BitcoinGUI::BitcoinGUI(const NetworkStyle* networkStyle, QWidget* parent)
  ...
  QString windowTitle = tr("Tessa Core") + " - ";
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle) {
  ...
  sendCoinsAction->setStatusTip(tr("Send coins to a Tessa address"));
  ...
  aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tessa Core"), this);
  aboutAction->setStatusTip(tr("Show information about Tessa Core"));
  aboutAction->setMenuRole(QAction::AboutRole);
  aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
  aboutQtAction->setStatusTip(tr("Show information about Qt"));
  aboutQtAction->setMenuRole(QAction::AboutQtRole);
  optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
  optionsAction->setStatusTip(tr("Modify configuration options for Tessa"));
  ...
  signMessageAction->setStatusTip(tr("Sign messages with your Tessa addresses to prove you own them"));
  verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
  verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tessa addresses"));
  ...
  showHelpMessageAction->setStatusTip(
      tr("Show the Tessa Core help message to get a list with possible Tessa command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle) {
  ...
  QString toolTip = tr("Tessa Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count) {
  ...
  labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tessa network", "", count));
}
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
  QString strTitle = tr("Tessa Core");  // default title
