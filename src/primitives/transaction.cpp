...
uint256 COutPoint::GetHash() { return Hash(BEGIN(hash), END(hash), BEGIN(n), END(n)); }
...
CMutableTransaction::CMutableTransaction() : nTransactionVersion(CTransaction::CURRENT_VERSION), nLockTime(0) {}
