 ...
 */
const std::string CLIENT_NAME("Tessa Core");
 ...
 * * include build.h, a file that is generated by the build environment, possibly containing the output
...
#define GIT_COMMIT_DATE "Mon, 27 Aug 2018 16:00:00 -0500"
#endif
